...
BORINGAF_USER_COLOR="%F{cyan}"
BORINGAF_PATH_COLOR="%F{magenta}"
BORINGAF_GIT_COLOR="%F{blue}"
BORINGAF_BRANCH_COLOR="%F{green}"
BORINGAF_TAG_COLOR="%F{cyan}"
BORINGAF_DIRTY_COLOR="%F{yellow}"
BORINGAF_CLEAN_COLOR="%F{green}"
BORINGAF_MUTED_COLOR="%F{default}"
